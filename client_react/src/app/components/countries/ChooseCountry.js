        ...
        return (
            <div className="col-12" key={product.id}>
                <div className={classNames('flex flex-column xl:flex-row xl:align-items-start p-4 gap-4', { 'border-top-1 surface-border': index !== 0 })}>
                    {/* <Avatar icon={<img src={`http://localhost:7788/uploads/${product.chef.picture.split("\\")[2]}`}> */}
                    {/* className="w-30 sm:w-50rem xl:w-50rem shadow-2 block xl:block mx-auto border-round"  */}
